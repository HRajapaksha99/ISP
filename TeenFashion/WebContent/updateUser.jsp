...
<head>
    ...
    <title>Update Info | Perfect Auction</title>
            ...
            <div class="container">
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="AdminUserServlet" method="POST" class="register-form" id="register-form"  onclick="return validate()">
                            <div class="form-group">
                                <label for="uId"><i class="fas fa-id-card-alt"></i></label>
                                <input type="text" name="uId" id="userid" placeholder="User ID"  value="<%=registerBean.getuId() %>"/>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                                <input type="text" name="type" id="type" placeholder="<%=registerBean.getU_type()%>"/>
                            </div>
                         ...
                         <div class="row">
                        	<div class="col-sm-12">
                               <form method="POST" action="DeleteUserServlet">
                                    <input type="hidden" name="id" value="<%=registerBean.getuId()%>" />
