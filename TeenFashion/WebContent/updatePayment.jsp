...
<head>
    ...
    <title>Update Payment | Perfect Auction</title>
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="UpdatePaymentServlet" method="POST" class="register-form" id="register-form"
                            ...
                            <input type="hidden" name="itemNo"    value="<%=p.getItem()%>"/>
                            <input type="hidden" name="name"   value="<%=p.getName()%>"/>
                            <div class="form-group">
                                <label for="id"><i class="far fa-credit-card"></i></label>
                                <input type="text" name="id" id="name" placeholder="ID"  value="<%= p.getId() %>"/>
                            </div>
                            <div class="form-group">
                                <label for="no"><i class="far fa-credit-card"></i></label>
                                <input type="tel" name="cardNo" placeholder="Credit Card Number" value="<%=p.getCardNo()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="fas fa-file-signature"></i></label>
                                <input type="text" name="cusName" id="e000mail" placeholder="Name On Card" value="<%=p.getCusName()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="date"><i class="fas fa-table"></i></label>
                                <input type="month" name="expiryDate" id="re_pass"  placeholder="Expiry Date" value="<%=p.getExpiryDate()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="cvv"><i class="fas fa-hashtag"></i></label>
                                <input type="tel" name="cvv" id="pass" placeholder="CVV Number" value="<%=p.getCvv()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="email"><i class="fas fa-envelope"></i></label>
                                <input type="email" name="cusEmail" id="pass" placeholder="Your Email" value="<%=p.getEmail()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="amount"><i class="fas fa-dollar-sign"></i></label>
                                <input type="text" name="amount" id="pass" placeholder="Amount" value="<%=p.getAmount()%>"/>
                            </div>
                            <div class="form-group">
                                <label for="phone"><i class="fas fa-phone"></i></label>
                                <input type="tel" name="phone" id="pass" placeholder="Your Phone " value="<%=p.getPhone()%>"/>
                            </div>
