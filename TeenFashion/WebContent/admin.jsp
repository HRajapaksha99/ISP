		...
		<div class="site-navbar bg-white py-2">
			...
			<div class="container">
				<div class="d-flex align-items-center justify-content-between">
					<div class="logo">
						<div class="site-logo">
							<a href="landPage.jsp" class="js-logo-clone"> <img
								src="images/pro/Logo2.png" alt=""
								style="width: 100px; height: 65px;"> NEXT AUCTION
							</a>
						</div>
					</div>
					<div class="main-nav d-none d-lg-block">
						<nav class="site-navigation text-right text-md-center"
							...
							<ul class="site-menu js-clone-nav d-none d-lg-block">
								<li class="has-children"><a href="landPage.jsp">Collection</a>
									<ul class="dropdown">
										<li><a href="#">Men</a></li>
					...
					<div class="icons">
						...
						<a href="cart.jsp" class="icons-btn d-inline-block bag"> <span
							...
							class="icon-menu"></span></a> <a href="landPage.jsp"> <span><i
								class="fas fa-user-tie"></i></span></a>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label for="">Brand</label> <br> <input type="text"
											class="form-control">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label for="">Style</label> <br> <input type="text"
											class="form-control">
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										<label for="">Color</label> <br> <input type="text"
											class="form-control">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group">
										<label for="">Item Number</label> <br> <input type="text"
											class="form-control">
									</div>
								</div>
							</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											<label>Start Date</label> <br> <input type="date"
												class="form-control">
										</div>
									</div>
									<div class="col-sm-6">
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<label>Starting Price ( $ )</label> <br> <input
											type="text" class="form-control">
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label>Buy it Now Price ( $ )</label> <br> <input
											type="text" class="form-control">
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label>Reserve Price ( $ )</label> <br> <input
											type="text" class="form-control">
									</div>
								</div>
							</div>
								...
								<div class="col-sm-3">
									<div class="input-group">
										<button type="button" class="btn btn-primary"
											value="Save & Draft">Save & Draft</button>
									</div>
								</div>
								<div class="col-sm-3">
									<div class="input-group">
